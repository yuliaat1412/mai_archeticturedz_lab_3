...
namespace database
{
    ...
    Message Message::fromJSON(const std::string &str)
    {
        ...
        message.chat_id() = object->getValue<long>("user_id");
        message.user_id() = object->getValue<long>("chat_id");
    ...
    std::optional<Message> Message::read_by_id(long id)
    {
        try
        {
            ...
            Message a;
            select << "SELECT id, user_id, chat_id, message FROM Message where id=?",
                into(a._id),
                into(a._user_id),
                into(a._chat_id),
                into(a._message),
 ...
 std::vector<Message> Message::read_by_chat_id(long chat_id)
    ...
    void Message::save_to_mysql()
    {
        ...
        try
        {
            ...
            insert << "INSERT INTO Message (user_id, chat_id, text) VALUES(?, ?, ?)",
                use(_user_id),
                use(_chat_id),
                use(_message);
